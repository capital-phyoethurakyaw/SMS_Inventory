namespace SMS.Order
{
    partial class frmF0021
    {
        ...
        private void InitializeComponent()
        {
            ...
            // reportViewer1
            // 
            reportDataSource1.Name = "Quotation";
            reportDataSource1.Value = this.dSF0006BindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "SMS.Report.RF0021.rdlc";
            ...
            this.Text = "F0021";
            this.Load += new System.EventHandler(this.F0021_Load);
