...
namespace SMS_BL
{
    public class PETC0302I_BL : Base_BL
    {
        ...
        {
            return NyuukinMeisaiDL.DynamicSelectData("*", "M_ShiwakeControl", "where [KEYCODE]= '1'");
        }
        ...
        {
            return TessuryouDL.Update_Tesuyou_Nyuukin(DataTableToXml(tesuyou), DataTableToXml(nyuukin));
        }

        public DataTable GetFolder()
        {
            return mdl.DynamicSelectData("Char1,Char2", "M_MultiPorpose", "WHERE ID = '114' AND [Key] = 1" );
        }
        public DataTable GetFolder3i()
        {
            return mdl.DynamicSelectData("Char1,Char2", "M_MultiPorpose", "WHERE ID = '117' AND [Key] = 1");
        }
